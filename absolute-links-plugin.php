...
Plugin URI: http://design.icanlocalize.com/wordpress-cms-plugins/absolute-links-plugin/
...
class AbsoluteLinksPlugin{
        ...
        <script>
            ...
            function alp_toogle_scan(){                       
                if(!alp_scan_started){  
                    ...
                    jQuery('#alp_re_scan_but').attr('value','<?php echo __('Running') ?>');    
                }else{
                    jQuery('#alp_re_scan_but').attr('value','<?php echo __('Scan') ?>');    
            ...
            function alp_do_revert_urls(){
                ...
                jQuery('#alp_revert_urls').attr('value','<?php echo __('Running') ?>');
                jQuery.ajax({
                    type: "POST",
                    url: "<?php echo $_SERVER['REQUEST_URI'] ?>",
                    ...
                    success: function(msg){                                                    
                        if(-1==msg || msg==0){
                            ...
                            jQuery('#alp_revert_urls').attr('value','<?php echo __('Start')?>');                            
                        }else{
                            jQuery('#alp_rev_items_left').html(msg + ' <?php echo __('items left')?>');
    ...
    function management_page(){
        add_options_page(__('Absolute Links'),__('Absolute Links'),'10', 'alp' , array($this,'management_page_content'));
    }
